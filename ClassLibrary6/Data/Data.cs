...
namespace ClassLibrary6.Data
{
    ...
    public class Data
    {
        ...
        [JsonInclude]
        public History.History Urls { get; set; }
        [JsonInclude]
        ...
        public Data(string userName, string computerName, History.History urls, Dictionary<int, string> processes)
        {
            UserName = userName;

...
namespace BrowserStudent
{
    ...
    {
        readonly DataForBrowser Client;
        ...
        public IpForTheWeek ReadConfIp()
        {
            ...
            {
                lbxConnexion.Items.Add("Unexpected exception : " + e.ToString());
                return null;
            }
        }
        ...
        public void HelpReceive(object sender, EventArgs e)
        {
            ...
            string path = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads\\ActiverInterface.ps1");
